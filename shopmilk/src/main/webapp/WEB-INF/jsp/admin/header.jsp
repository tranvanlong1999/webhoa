			...
			<ul class="nav navbar-nav">
							...
							<ul class="menu">
								<li>
									<!-- start message --> <a href="#">
										<div class="pull-left">
											<img src="static/admin/img/photo.jpg"
												class="img-circle" >
										</div>
										<h4>
								...
								<li><a href="#">
										<div class="pull-left">
											<img src="static/admin/img/photo04.jpg"
												class="img-circle" >
										</div>
										<h4>
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="static/admin/img/phot.jpg" class="user-image"
						> <span class="hidden-xs">Nhóm 4</span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header"><img
							src="static/admin/img/photo04.jpg" class="img-circle"
							>
